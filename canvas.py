...
class DigitRecognizerApp:
    def __init__(self, model):
        ...
        tk.Button(button_frame, text="Predict", command=self.predict_digit).grid(row=0, column=0, padx=10)
        tk.Button(button_frame, text="Clear", command=self.clear_canvas).grid(row=0, column=1, padx=10)
